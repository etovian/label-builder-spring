        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('labelbuilderApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-labelbuilderApp-error');
                                var entityKey = httpResponse.headers('X-labelbuilderApp-params');
                                if (errorHeader) {
